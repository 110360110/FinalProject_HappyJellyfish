...
public class FifteenPuzzleGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fifteen_puzzle_game);
    ...
    private void saveData(){
        steps = new Steps(FifteenPuzzleGameActivity.this);
    ...
    public void onBackPressed(){
        super.onBackPressed();
        setResult(FifteenPuzzleMainActivity.REQUEST_CODE);
    }
}